...
import com.app.skilledlabour.activities.Admin.QueryDetails;
import com.app.skilledlabour.models.Query;

import java.util.Collections;
import java.util.List;

public class QueryAdminAdapter extends RecyclerView.Adapter<QueryAdminAdapter.MyBook> {
    List<Query> list = Collections.emptyList();
    Context mContext;
    public QueryAdminAdapter(List<Query> list, Context context){
        this.list = list;
    ...
    public MyBook onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new QueryAdminAdapter.MyBook(v);
    }
    @Override
