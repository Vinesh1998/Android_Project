...
import com.app.skilledlabour.activities.Customer.QueryDetails;
import com.app.skilledlabour.models.Query;

import java.util.Collections;
import java.util.List;

public class QueryCustAdapter extends RecyclerView.Adapter<QueryCustAdapter.MyBook> {
    List<Query> list = Collections.emptyList();
    Context mContext;
    public QueryCustAdapter(List<Query> list, Context context){
        this.list = list;
    ...
    public MyBook onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new QueryCustAdapter.MyBook(v);
    }
    @Override
